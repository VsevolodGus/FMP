...
namespace Bioss.Ultrasound.Services
{
    ...
    public class PdfGeneratorService2 : IPdfGenerator
    {
        private readonly InfoSettingsService _infoService;

        public PdfGeneratorService2(InfoSettingsService infoService)
        {
        ...
        private PdfDocument CreateDocument()
        {
            ...
            document.Info.Title = "FMP";
            document.Info.Author = "Bioss";
            document.Info.Subject = "Created with FMP app";
            document.Info.Keywords = "FMP, Bioss, Pregnant";
            return document;
        }
        ...
        private void AddData(PdfDocument document, Record record)
        {
            ...
            for (var i = 0; i < pages; ++i)
            {
                ...
                helper.DrawData(graphics, page, record.Biometric, record.RecordingTimeSpan, fetalsCount, researchTime, _infoService.PregnancyStart);
                ...
                //helper.DrawVerticalRullerTest(graphics, XUnit.FromMillimeter(55 + 2.5), XUnit.FromMillimeter(9));
            }
        }
        ...
        public class OxyPdfHelper
        {
            ...
            public void DrawChart(XGraphics gfx, PlotModel model)
            {
                ...
                var top = XUnit.FromMillimeter(70).Point;
